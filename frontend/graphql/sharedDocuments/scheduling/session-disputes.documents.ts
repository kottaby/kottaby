 ...
 * case read (`teacherDisputeCase`) and the session's OWN student's — the filing
 * party's — exact mirror (`studentDisputeCase`). Every `Session` payload selects `id` first so
