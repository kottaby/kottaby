...
export type PurchaseVerificationPlanMutation_purchaseVerificationPlan_subscription = { id: string, status: SubscriptionStatus, planId: number, paymentMethod: PaymentGateway | null, paymentReference: string | null, paymentVerifiedAt: string | null, startDate: string | null, endDate: string | null, createdAt: string, updatedAt: string };

export type PurchaseVerificationPlanMutation_purchaseVerificationPlan_payment = { id: string, amount: string, currency: string, status: PaymentStatus, paymentGateway: PaymentGateway, subscriptionId: number | null, createdAt: string, updatedAt: string };
