...
export type AdminTeacherApplicantsQuery_adminTeacherApplicants = { total: number, page: number, pageSize: number, pageCount: number, items: Array<AdminTeacherApplicantsQuery_adminTeacherApplicants_items> };
