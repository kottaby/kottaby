...
interface TeacherSessionsDialogsProps {
 ...
 */
export function TeacherSessionsDialogs({
  ...
  onDisputeFailure,
}: Readonly<TeacherSessionsDialogsProps>): ReactNode {
  return (
    <>
