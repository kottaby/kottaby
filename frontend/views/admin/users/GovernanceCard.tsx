...
import type { DirectoryGovernance } from "@/frontend/views/admin/users/adminUsersDirectory.helpers";
import { DirectoryGovernanceLabel } from "@/frontend/views/admin/users/DirectoryRowCells";
import {
  DetailCard,
  DetailCardTitle,
  DetailEyebrow,
