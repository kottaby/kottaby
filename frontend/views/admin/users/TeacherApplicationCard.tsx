...
import { ApplicantStatusChip } from "@/frontend/views/admin/users/ApplicantStatusChip";
import { StatsPanel, TeacherFlagRow } from "@/frontend/views/admin/users/TeacherApplicationPanels";
import { ApplicationStepper } from "@/frontend/views/admin/users/TeacherApplicationStepper";
import { DetailCard, DetailCardTitle, DetailInfoStrip } from "@/frontend/views/admin/users/UserDetailPrimitives";
