...
/**
 * AdminTeacherDetailDrawer primitives — the shared layout atoms of the
 * drawer's section cards: the section card shell (uppercase pinned header),
 * the caption/value row (the `ProfileInfoCard` recipe), and the honest
 * em-dash null value.
 */
