 ...
 * identity (avatar/name/email + copy-email quick action), session balances
 * (four compact badges), parent identity, language chips, trial state, and
 * the localized joined timestamp.
 *
...
export function AdminStudentRow({ student, labels, locale, striped, onCopyEmail }: AdminStudentRowProps): ReactNode {
  return (
    <TableRow
      sx={theme => ({
        height: 72,
    ...
    >
      <StudentIdentityCell student={student} labels={labels} onCopyEmail={onCopyEmail} />
