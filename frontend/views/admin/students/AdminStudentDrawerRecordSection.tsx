...
/**
 * AdminStudentDrawerRecordSection — the student detail drawer's record
 * section (extracted from `AdminStudentDetailDrawer`): the record
 * identifier (wire value, never localized) plus the explicit full-profile
 * link: governance actions live on the admin user-detail page, so the
 * drawer bridges the directory to that surface instead of duplicating them
 * here.
 */
...
export function StudentDrawerRecordSection({ student, labels }: StudentDrawerRecordSectionProps): ReactNode {
  return (
