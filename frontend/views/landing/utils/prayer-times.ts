...
/**
 * Module-scoped DateTimeFormat instance for Cairo UTC offset calculation.
 * Instantiating Intl.DateTimeFormat once at module initialization avoids high
 * instantiation overhead on repeated tick evaluations (~30x speedup).
 */
