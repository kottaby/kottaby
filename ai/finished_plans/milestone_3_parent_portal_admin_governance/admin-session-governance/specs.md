...
> **Milestone:** 3 · **Owner Stream:** Dev 3 · **Effort:** 5 SP
> **Target ticket:** (docs/planning/TICKETS.md §Milestone 3; decision refs FR-10.3, A.5)
> **Plan directory (verbatim):** `ai/plans/milestone_3_parent_portal_admin_governance/admin-session-governance`
