...
1. **Pre-Execution Outcome Knowledge Read:** before ANY task, read ALL files in `ai/plans/milestone_4_integration_security_launch/disaster-recovery-backup-verification/outcome/`.
