...
1. WHEN implementation begins THEN the agent SHALL record `bun tsgo`, `bun biome:check`, and lint baselines into `/tmp/baseline-*` and write `ai/plans/sprint_2/dev3-012-dual-confirmation-completion-handshake/outcome/0-baseline-outcome.md`.
