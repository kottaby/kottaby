...
**Plan directory (verbatim):** `ai/plans/sprint_3/student-confirmation-of-parent-link`
**Specs (approved):** `ai/plans/sprint_3/student-confirmation-of-parent-link/specs.md`
**Deferred-items ledger (to be created at Task 0):** `ai/plans/sprint_3/student-confirmation-of-parent-link/deferred-items.md`
**Outcome directory:** `ai/plans/sprint_3/student-confirmation-of-parent-link/outcome/`
...
- **Target Directory**: `ai/plans/sprint_3/student-confirmation-of-parent-link/`
- **Outcome Directory**: `ai/plans/sprint_3/student-confirmation-of-parent-link/outcome/`
...
- **Related Documents**: `specs.md` (requirements), `tasks.md` (execution), `docs/parents/parent-link-request.md` (canonical domain doc), `ai/plans/sprint_3/*/` (substrate outcome)
