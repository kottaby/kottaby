...
> **Plan of record:** `ai/plans/sprint_3/broadcast-notifications-system-wide-targ/`
...
- **Knowledge propagation (REQ-081):** `backend/services/AGENTS.md` broadcast-service one-liner; `docs/notifications/realtime-engine.md` §3.2 row marked shipped; `backend/db/repo/AGENTS.md` audience-repository convention line; root `AGENTS.md` Important References gains the canonical doc entry; outcome files under `ai/plans/sprint_3/broadcast-notifications-system-wide-targ/outcome/` per task.
