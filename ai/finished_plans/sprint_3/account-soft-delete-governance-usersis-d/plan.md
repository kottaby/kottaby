...
> **Plan directory (verbatim — every header, ledger path, and self-reference in this plan uses exactly this string):** `ai/plans/sprint_3/account-soft-delete-governance-usersis-d`
...
## Deferred-Items Ledger Pointers (initial content for `ai/plans/sprint_3/account-soft-delete-governance-usersis-d/deferred-items.md`)
...
Final gate: `grep -c "❌\|⚠️" ai/plans/sprint_3/account-soft-delete-governance-usersis-d/deferred-items.md` = 0 at completion (REQ-075).
