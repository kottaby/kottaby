...
> **Plan directory (verbatim — every header, ledger path, and self-reference in this plan uses exactly this string):** `ai/plans/sprint_3/parent-child-link-request-workflow-7-day`
...
## Deferred-Items Ledger Pointers (initial content for `ai/plans/sprint_3/parent-child-link-request-workflow-7-day/deferred-items.md`)
