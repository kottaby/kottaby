...
> **Plan of record:** `ai/plans/sprint_3/cold-start-bootstrapping-direct-sheikh-c/`
> **Specs:** `ai/plans/sprint_3/cold-start-bootstrapping-direct-sheikh-c/specs.md` (REQ-001..REQ-083, journey J-1)
...
> **Ledger:** `ai/plans/sprint_3/cold-start-bootstrapping-direct-sheikh-c/deferred-items.md` (initialized in Task 0)
...
## Deferred items (pre-registered in `ai/plans/sprint_3/cold-start-bootstrapping-direct-sheikh-c/deferred-items.md` at Task 0 — resolved-as-reference entries only)
