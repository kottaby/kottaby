...
> **Plan directory (verbatim):** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement`
> **Specs:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/specs.md` · **Plan:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/plan.md`
> **Ledger:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/deferred-items.md` · **Outcomes:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/outcome/`
...
- [x] 4.2 Final gate & ledger close
  - Re-run full-file quality loop for every file touched this plan; confirm baseline counts unchanged; `grep -c "❌\|⚠️" ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/deferred-items.md` audit (any residual must reference an owning ticket).
