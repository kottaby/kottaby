...
> **Specs of record:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/specs.md`
> **Tasks of record:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/tasks.md`
> **Deferred-items ledger:** `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/deferred-items.md`
...
- `ai/plans/milestone_1_core_domain_mvp/session-report-homework-infrastructure/` — consumer plan
