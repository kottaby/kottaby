...
<!-- Plan directory (verbatim — used in every header and self-reference):
     ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement -->

- **Feature Name**: Session Status State Machine Enforcement
- **Ticket**: Session Status State Machine (docs/planning/TICKETS.md:1024) — Milestone 1, Dev 3, 3 SP, blocked by the Session Creation & Lifecycle ticket (shipped, PR #46)
- **Target Directory**: `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/`
- **Outcome Directory**: `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/outcome/`
...
#### Acceptance Criteria
1. WHEN implementation begins THEN system SHALL record baseline error counts (tsgo / biome / lint / oxlint) into `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/outcome/0.1-baseline-outcome.md`.
2. WHEN implementation begins THEN system SHALL initialize `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/deferred-items.md` from `.agents/spec-process-guide/templates/deferred-items-template.md`.
...
5. WHEN any subtask completes THEN the checkbox in `ai/plans/milestone_1_core_domain_mvp/session-status-state-machine-enforcement/tasks.md` SHALL flip `[ ]` → `[x]`.
