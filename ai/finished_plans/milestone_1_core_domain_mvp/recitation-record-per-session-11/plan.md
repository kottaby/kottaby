...
**Plan directory (verbatim — all artifacts, ledger paths, and self-references in this plan use exactly this string):** `ai/plans/milestone_1_core_domain_mvp/recitation-record-per-session-11`
**Ticket:** this ticket · Milestone 1 · Dev 3 · 2 SP · Blocked-By satisfied (the Session Creation & Lifecycle ticket shipped — `docs/sessions/session-lifecycle.md`)
