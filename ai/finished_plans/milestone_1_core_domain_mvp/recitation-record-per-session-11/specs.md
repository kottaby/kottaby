...
**Plan directory (verbatim):** `ai/plans/milestone_1_core_domain_mvp/recitation-record-per-session-11`
...
|---|---|---|---|---|---|
| REQ-001 baseline/ledger | — (process) | — | — | — | `ai/plans/milestone_1_core_domain_mvp/recitation-record-per-session-11/outcome/0-baseline-outcome.md` + `deferred-items.md` |
