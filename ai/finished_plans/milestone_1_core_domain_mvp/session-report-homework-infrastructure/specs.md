...
**Feature slug / plan directory (verbatim):** `ai/plans/milestone_1_core_domain_mvp/session-report-homework-infrastructure`
...
**Plan ledger path:** `ai/plans/milestone_1_core_domain_mvp/session-report-homework-infrastructure/deferred-items.md`
...
- **REQ-001 (Pre-Implementation Baseline & Ledger):** WHEN implementation begins THEN system SHALL record baseline error counts (`tsgo`, `biome:check`, `lint-service`, `oxlint`) into `ai/plans/milestone_1_core_domain_mvp/session-report-homework-infrastructure/outcome/0-baseline-outcome.md` AND initialize `ai/plans/milestone_1_core_domain_mvp/session-report-homework-infrastructure/deferred-items.md` from `.agents/spec-process-guide/templates/deferred-items-template.md`.
