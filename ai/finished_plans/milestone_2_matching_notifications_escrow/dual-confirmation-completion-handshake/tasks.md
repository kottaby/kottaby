...
1. **Pre-Execution Read:** read ALL files in `ai/plans/milestone_2_matching_notifications_escrow/dual-confirmation-completion-handshake/outcome/` before ANY task.
