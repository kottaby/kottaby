...
> **Plan directory:** `ai/plans/recitation-selection-on-registration/`
...
- **REQ-001** (`baseline`): WHEN implementation begins THEN the executing agent SHALL record baseline `tsgo`, `biome`, and `lint-service` counts and SHALL initialize `ai/plans/recitation-selection-on-registration/deferred-items.md` and `outcome/phase0-baseline-outcome.md`.
...
|---|---|---|---|---|
| REQ-001 / REQ-002 | Plan baseline `ai/plans/recitation-selection-on-registration/` | — | — | `outcome/phase0-baseline-outcome.md`; plan-review gate |
