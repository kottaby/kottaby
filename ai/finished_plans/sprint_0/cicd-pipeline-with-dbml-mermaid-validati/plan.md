...
> **Spec**: `ai/plans/ci-cd-pipeline/specs.md` (REQ-001..REQ-085)
...
All evidence lands in `ai/plans/ci-cd-pipeline/outcome/` per the outcome protocol (REQ-084) and is referenced from the canonical doc's Rollout Summary (REQ-080).
...
- Completion gate: `grep -c "❌\|⚠️" ai/plans/ci-cd-pipeline/deferred-items.md` must equal `0` before plan sign-off (REQ-083).
