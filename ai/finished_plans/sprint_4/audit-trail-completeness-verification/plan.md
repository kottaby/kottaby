...
- **Spec**: `ai/plans/sprint_4/audit-trail-completeness-verification/specs.md`
- **Plan Directory**: `ai/plans/sprint_4/audit-trail-completeness-verification`
...
- BEFORE any task: executing agent reads ALL of `ai/plans/sprint_4/audit-trail-completeness-verification/outcome/`.
