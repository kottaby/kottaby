...
> **Specs of record:** `ai/plans/sprint_1/session-status-state-machine-enforcement/specs.md`
> **Tasks of record:** `ai/plans/sprint_1/session-status-state-machine-enforcement/tasks.md`
> **Deferred-items ledger:** `ai/plans/sprint_1/session-status-state-machine-enforcement/deferred-items.md`
...
- `ai/plans/sprint_1/session-report-homework-infrastructure/` — consumer plan
