...
**Plan directory (verbatim):** `ai/plans/sprint_1/recitation-record-per-session-11`
...
|---|---|---|---|---|---|
| REQ-001 baseline/ledger | — (process) | — | — | — | `ai/plans/sprint_1/recitation-record-per-session-11/outcome/0-baseline-outcome.md` + `deferred-items.md` |
