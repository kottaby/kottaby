...
**Plan directory (verbatim — every header, ledger path, outcome path, and self-reference in this file uses exactly this string):** `ai/plans/sprint_1/recitation-record-per-session-11`
...
**Inputs:** `ai/plans/sprint_1/recitation-record-per-session-11/specs.md` · `ai/plans/sprint_1/recitation-record-per-session-11/plan.md`
...
1. **Pre-Execution outcome knowledge read.** Before starting any task, read every existing file under `ai/plans/sprint_1/recitation-record-per-session-11/outcome/` plus `ai/plans/sprint_1/recitation-record-per-session-11/deferred-items.md`. Do not re-derive a decision a prior outcome already settled; do not repeat an already-recorded deferral.
...
5. **Outcome documentation.** Every completed task writes `ai/plans/sprint_1/recitation-record-per-session-11/outcome/<task-id>-outcome.md` capturing: what shipped, deviations from plan, verification evidence (commands + exit codes), deferred discoveries.
...
- **Artifacts:**
  - `ai/plans/sprint_1/recitation-record-per-session-11/outcome/0-baseline-outcome.md` (CREATE)
  - `ai/plans/sprint_1/recitation-record-per-session-11/deferred-items.md` (CREATE, initialized verbatim from `.agents/spec-process-guide/templates/deferred-items-template.md`)
- **Work:**
...
- **Accept:** plan directory self-references are verbatim `ai/plans/sprint_1/recitation-record-per-session-11` everywhere; no task left `[ ]`; ledger reconciled.
