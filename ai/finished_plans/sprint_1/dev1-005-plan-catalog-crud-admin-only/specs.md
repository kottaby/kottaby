...
**End of Specification — this ticket.** Ready for `ai/plans/dev1-005-plan-catalog-crud-admin-only/plan.md` (Phase 2 design), gated by `@plan-review` (Phase 1.5) before any implementation begins.
