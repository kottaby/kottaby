...
- [x] 0.1 [Record baseline and seed deferred-items ledger]
  ...
  - Initialize `ai/plans/sprint_1/session-creation-lifecycle-scheduled-sta/deferred-items.md` (the file already EXISTS in this plan dir as an empty template; plan.md — updated separately — defines D1–D5, extended D6–D7 by gate rulings) by seeding the following non-blocking forward items into it:
