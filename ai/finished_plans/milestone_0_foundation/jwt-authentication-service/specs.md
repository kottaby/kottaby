...
> **Plan directory:** `ai/plans/jwt-authentication-service/`
...
- **REQ-001** (`baseline`): WHEN implementation begins THEN the executing agent SHALL record baseline `tsgo` / `biome` / `lint-service` counts and SHALL initialize `ai/plans/jwt-authentication-service/deferred-items.md` and `outcome/phase0-baseline-outcome.md`.
...
|---|---|---|---|---|
| REQ-001 / REQ-002 | Plan baseline `ai/plans/jwt-authentication-service/` | — | — | `outcome/phase0-baseline-outcome.md`; plan-review gate |
