...
**Plan directory:** `ai/plans/schema-migration/` · **Outcome directory:** `ai/plans/schema-migration/outcome/` · **Ledger:** `ai/plans/schema-migration/deferred-items.md`

## Non-Negotiable Execution Protocol
1. Pre-Execution: Read all outcome files in `ai/plans/schema-migration/outcome/`
...
- [x] 7.3 Write `outcome/7.x-knowledge-propagation-outcome.md`; final sweep of all outcome files; mark all checkboxes `[x]`; compile Execution Summary (baseline vs final: tsgo/biome/lint deltas, review rounds, files changed)
    > Consolidated outcome at `outcome/consolidated-outcome.md`; Execution Summary appended to `worklog.md` under `## Implementation Summary`.
