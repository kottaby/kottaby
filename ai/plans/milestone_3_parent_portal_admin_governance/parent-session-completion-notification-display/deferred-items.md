...
| D5 | Mid-point backend review wave (review-backend / review-types / review-config over Task 3–4 files) | 3 | 4.5 | ❌ Blocked | — | Task 4.5 review gate (REQ-060); must complete before Task 5 begins (lifecycle isolation — no cross-stage interleaving). |
