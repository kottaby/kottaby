...
- [ ] T7.1 Post-implementation review iterations (independent fresh subagents) until 0 new findings in 2 consecutive rounds
- [ ] T7.2 Deferred-items enforcement: `grep -c "❌\|⚠️" deferred-items.md` == 0
