...
> **Plan directory (verbatim, used by every header/ledger/self-reference):** `ai/plans/sprint_1/session-report-homework-infrastructure`
> **Specs of record:** `ai/plans/sprint_1/session-report-homework-infrastructure/specs.md` (REQ-001…REQ-072)
> **Ledger:** `ai/plans/sprint_1/session-report-homework-infrastructure/deferred-items.md`
> **Outcome dir:** `ai/plans/sprint_1/session-report-homework-infrastructure/outcome/`
...
- Docs/knowledge: `docs/sessions/session-report-homework.md` canonical doc; REQ-072 amendment of `docs/sessions/session-lifecycle.md` §10 (INV-S7/S8 now landed here); AGENTS.md pointers; ledger at `ai/plans/sprint_1/session-report-homework-infrastructure/deferred-items.md` pre-seeded with D1 (full 114-surah enum expansion), D2 (parent read surface → the parent-portal ticket), D3 (submit UX → the submit-UX ticket), D4 (rating aggregation → the rating-aggregation ticket), D5 (report amendment semantics — future compensating-artifact flow).
