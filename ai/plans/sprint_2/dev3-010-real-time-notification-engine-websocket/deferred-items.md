...
> **D1–D4 are pre-seeded non-blocking forward items with owning tickets; D5 was added at Task 5.1 (pinned discovery — see Notes). Final gate `grep -c "❌\|⚠️"` excludes them (all 🔄).**
