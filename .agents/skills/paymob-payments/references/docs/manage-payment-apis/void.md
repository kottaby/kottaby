---
title: "Void"
url: https://developers.paymob.com/paymob-docs/manage-payment-apis/void
tab: developers
breadcrumbs: "Manage Payment APIs > Void"
---
...
### Response 200 — Void API Response

- `id` (number) — Unique identifier for the transaction _(example: `579405`)_
...
- `order` (object) — Order details associated with this transaction
  - `id` (number) — Unique identifier for the transaction _(example: `696352`)_
  - `created_at` (string) — Timestamp when the record was created _(example: `2024-10-03T18:20:26.048547+04:00`)_
  ...
  - `merchant` (object) — Merchant information
    ...
    - `phones` (array) — List of phone numbers
      - `0` (string) _(example: `1052zxxxxxxxxx`)_
  ...
  - `shipping_data` (object) — Customer shipping information
    - `id` (number) — Unique identifier for the transaction _(example: `491512`)_
    ...
    - `phone_number` (string) — Customer phone number _(example: `+9234xxxxxxxx`)_
    - `postal_code` (string) — Postal or ZIP code _(example: `NA`)_
    - `extra_description` (string)
    - `shipping_method` (string) _(example: `UNK`)_
    - `order_id` (number) — The unique order identifier _(example: `696352`)_
    - `order` (number) — Order details associated with this transaction _(example: `696352`)_
  ...
  - `is_returned` (boolean)
  - `is_canceled` (boolean)
  - `merchant_order_id` (string) _(example: `phe4sjw111-19243-211`)_
  ...
  - `data` (object)
- `created_at` (string) — Timestamp when the record was created _(example: `2024-10-03T21:37:24.222073+04:00`)_
...
- `is_void` (boolean) _(example: `true`)_
- `is_refund` (boolean)
- `data` (object)
  - `gateway_integration_pk` (number) _(example: `158`)_
  - `klass` (string) _(example: `MigsPayment`)_
  - `created_at` (string) — Timestamp when the record was created _(example: `2024-10-03T17:37:25.784331`)_
  ...
  - `migs_order` (object)
    ...
    - `chargeback` (object)
      ...
      - `currency` (string) — Currency code (e.g., EGP, USD) _(example: `EGP`)_
    - `creationTime` (string) _(example: `2024-10-03T14:21:44.858Z`)_
    - `currency` (string) — Currency code (e.g., EGP, USD) _(example: `EGP`)_
    - `id` (string) — Unique identifier for the transaction _(example: `696352`)_
    - `lastUpdatedTime` (string) _(example: `2024-10-03T17:37:25.613Z`)_
    - `merchantAmount` (number) _(example: `20`)_
    - `merchantCategoryCode` (string) _(example: `1234`)_
    - `merchantCurrency` (string) _(example: `EGP`)_
    - `status` (string) — Current status of the record _(example: `CANCELLED`)_
  ...
  - `migs_transaction` (object)
    - `acquirer` (object)
      ...
      - `id` (string) — Unique identifier for the transaction _(example: `xxxx_S2I`)_
    ...
    - `amount` (number) — Transaction amount in cents _(example: `20`)_
    - `authorizationCode` (string) _(example: `002095`)_
    - `currency` (string) — Currency code (e.g., EGP, USD) _(example: `EGP`)_
    - `id` (string) — Unique identifier for the transaction _(example: `579405`)_
    - `receipt` (string) _(example: `427717329277`)_
    - `source` (string) _(example: `INTERNET`)_
    - `stan` (string) _(example: `2095`)_
    - `targetTransactionId` (string) _(example: `578645`)_
    - `terminal` (string) _(example: `MASS2I05`)_
    - `type` (string) _(example: `VOID_PAYMENT`)_
  - `txn_response_code` (string) _(example: `APPROVED`)_
  - `acq_response_code` (string) _(example: `00`)_
  - `message` (string) _(example: `Approved`)_
  - `merchant_txn_ref` (string) _(example: `579405`)_
  - `order_info` (string) _(example: `696352`)_
  - `receipt_no` (string) _(example: `427717329277`)_
  ...
  - `authorize_id` (string) — Authorization ID from the payment processor _(example: `002095`)_
...
- `captured_amount` (number) — The amount that has been captured in cents
- `merchant_staff_tag` (string) — Staff tag for merchant tracking
- `updated_at` (string) — Timestamp when the record was last updated _(example: `2024-10-03T21:37:25.793101+04:00`)_
...
- `parent_transaction` (number) — Parent transaction ID _(example: `578645`)_
