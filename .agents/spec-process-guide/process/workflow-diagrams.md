...
stateDiagram-v2
    ...
    state Requirements {
        [*] --> Kottaby_Req : Create Initial Requirements
        Kottaby_Req --> Review_Req : Complete Kottaby
        Review_Req --> Revise_Req : Feedback/Changes
        Revise_Req --> Review_Req : Updated Kottaby
    ...
    state Design {
        ...
        Research --> Kottaby_Design : Create Design Document
        Kottaby_Design --> Review_Design : Complete Kottaby
        Review_Design --> Revise_Design : Feedback/Changes
        Revise_Design --> Review_Design : Updated Kottaby
    ...
    state Tasks {
        [*] --> Kottaby_Tasks : Create Task Breakdown
        Kottaby_Tasks --> Review_Tasks : Complete Kottaby
        Review_Tasks --> Revise_Tasks : Feedback/Changes
        Revise_Tasks --> Review_Tasks : Updated Kottaby
...
flowchart TD
    ...
    B --> C[Create Initial Requirements Kottaby]
