...
## How
- **Baseline:** Record error count before starting (`bun run scripts/health/sub-loop.ts <file> --lifecycle duplicates` exit code)
- [Implementation step 1]
- [Implementation step 3]
- **Testing ([.agents/skills/write-tests/SKILL.md](file:///home/ahmed/Projects/kottaby/.agents/skills/write-tests/SKILL.md) / [.agents/skills/test-expert/SKILL.md](file:///home/ahmed/Projects/kottaby/.agents/skills/test-expert/SKILL.md)):** Write a paired test for the change (test edge cases/boundaries, verify regression is prevented)
- **Quality Loop:** `bun run scripts/health/sub-loop.ts <file> --lifecycle duplicates` after each change (exit code 0 = pass)
...
**Note:** Micro specs skip all formal review phases (1.5, 2.5, 4) and knowledge propagation for speed. Use for <1 day changes only.
