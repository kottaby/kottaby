/**
 * PlansCheckoutFunnelJourney — cross-container component suite ENTRY
 * (runner target).
 *
 * Happy DOM + Apollo `MockedProvider` tier (`test/ui/components/student`,
 * mirroring the sibling funnel suites): the suite BODY lives in the sibling
 * `PlansCheckoutFunnelJourney.suite.tsx` — the CROSS-CONTAINER Apollo-cache
 * interplay between the purchase funnel's three surfaces (plans catalog →
 * purchase mutation → payment result → my subscriptions), driven across
 * BOTH locales.
 *
...
await import("./PlansCheckoutFunnelJourney.suite");
