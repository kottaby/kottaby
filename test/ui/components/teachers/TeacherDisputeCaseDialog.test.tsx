/**
 * TeacherDisputeCaseDialog — component suite ENTRY (runner target).
 *
 * Happy DOM + Apollo `MockedProvider` tier (`test/ui/components/teachers`,
 * mirroring the admin case-review dialog suite exactly): the suite BODY
 * lives in the sibling `TeacherDisputeCaseDialog.suite.tsx`.
 *
...
await import("./TeacherDisputeCaseDialog.suite");
