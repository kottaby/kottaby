/**
 * AdminDisputeAnalyticsCard — component suite ENTRY (runner target).
 *
 * Happy DOM tier (`test/ui/components/admin`, mirroring the
 * disputes-family entries exactly): the suite BODY lives in the sibling
 * `AdminDisputeAnalyticsCard.suite.tsx`.
 *
 * WHY this file exists (two-phase bootstrap) — identical root cause to the
 * disputes-family entries: Bun evaluates an entry test file's node_modules
...
await import("./AdminDisputeAnalyticsCard.suite");
