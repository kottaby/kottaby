/**
 * AdminDisputeCaseDialog — component suite ENTRY (runner target).
 *
 * Happy DOM + Apollo `MockedProvider` tier (`test/ui/components/admin`,
 * mirroring the sessions-family entries exactly): the suite BODY lives in
 * the sibling `AdminDisputeCaseDialog.suite.tsx`.
 *
...
await import("./AdminDisputeCaseDialog.suite");
