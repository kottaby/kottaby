/**
 * StudentDisputeCaseDialog — component suite ENTRY (runner target).
 *
 * Happy DOM + Apollo `MockedProvider` tier (`test/ui/components/students`,
 * the exact mirror of the teacher case dialog suite): the suite BODY lives
 * in the sibling `StudentDisputeCaseDialog.suite.tsx`.
 *
 * WHY this file exists (two-phase bootstrap) — identical root cause to the
 * sessions-family entries: Bun evaluates an entry test file's node_modules
...
await import("./StudentDisputeCaseDialog.suite");
