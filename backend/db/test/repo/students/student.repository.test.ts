/**
 * StudentRepository read-method tests — `findHandshakeCodeByStudentId` and
 ...
 *    entity-setup fixtures; the discovery JOIN returns EXACTLY the picked
 *    columns (Object.keys assertion — no extra columns).
 ...
 *    after the forced rollback, on both read methods.
 */
