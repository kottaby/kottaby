...
- **Schema-DBML Reconciliation**: Before authoring any new table/enum, reconcile against `db/schema.dbml` (the sole structural ground truth per REQ-002). See `docs/drizzle/dbml-to-drizzle-schema-migration.md` for the canonical method.
