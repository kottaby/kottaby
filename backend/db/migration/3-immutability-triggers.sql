...
CREATE TRIGGER prevent_student_payments_update_trigger
    ...
    FOR EACH ROW
    EXECUTE FUNCTION prevent_student_payments_update();
...
CREATE TRIGGER prevent_student_payments_delete_trigger
    ...
    FOR EACH ROW
    EXECUTE FUNCTION prevent_student_payments_delete();
...
CREATE TRIGGER prevent_teacher_transaction_update_trigger
    ...
    FOR EACH ROW
    EXECUTE FUNCTION prevent_teacher_transaction_update();
...
CREATE TRIGGER prevent_teacher_transaction_delete_trigger
    ...
    FOR EACH ROW
    EXECUTE FUNCTION prevent_teacher_transaction_delete();
