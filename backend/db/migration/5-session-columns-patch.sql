...
ALTER TABLE "session" ADD COLUMN IF NOT EXISTS "held_balance_lane" varchar(20);
ALTER TABLE "session" ADD COLUMN IF NOT EXISTS "cancel_reason" varchar(500);
ALTER TABLE "session" ADD COLUMN IF NOT EXISTS "dispute_reason" varchar(500);
ALTER TABLE "session" ADD COLUMN IF NOT EXISTS "disputed_at" timestamp;
ALTER TABLE "session" ADD COLUMN IF NOT EXISTS "resolution_note" varchar(500);
ALTER TABLE "session" ADD COLUMN IF NOT EXISTS "resolved_at" timestamp;
