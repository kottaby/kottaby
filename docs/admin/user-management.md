...
> Consumer pointer (DEV3-022c): the admin platform-analytics service reuses `AdminUserRepository.getStats` verbatim for its users section — see `docs/admin/platform-analytics.md`; the user-management contract itself is unchanged.
