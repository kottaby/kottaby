...
- Registration outcomes (`ai/plans/milestone_0_foundation/*/outcome/`) — The registration transaction pattern, BOPLA whitelist, SAVEPOINT-aware test isolation, and 23505→ConflictError cause-chain traversal that the trial grant inherits unchanged.
