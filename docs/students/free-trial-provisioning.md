...
- Registration outcomes (`ai/plans/sprint_0/dev1-002-*/outcome/`) — The registration transaction pattern, BOPLA whitelist, SAVEPOINT-aware test isolation, and 23505→ConflictError cause-chain traversal that the trial grant inherits unchanged.
