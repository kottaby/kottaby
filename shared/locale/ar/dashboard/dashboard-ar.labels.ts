...
export const dashboardAr: DashboardLabels = {
  ...
  plans: "الباقات",
  audit: "سجل التدقيق",
  verificationQueue: "التحقق من المدفوعات",
  ...
  dashboardMetaTitle: "لوحة التحكم — أكاديمية كتّاب",
  dashboardMetaDescription: "لوحة تحكم أكاديمية كتّاب — الجلسات، الرصيد، القادمة، والإشعارات.",
  profileMetaTitle: "الملف الشخصي — أكاديمية كتّاب",
  profileMetaDescription: "عرض معلومات ملفك الشخصي في أكاديمية كتّاب.",
  comingSoonMetaTitle: "قريباً — أكاديمية كتّاب",
