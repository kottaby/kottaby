...
export const errorsAr: ErrorsLabels = {
  ...
  subscriptionAdmin: {
    notActive: "هذا الإجراء متاح فقط للاشتراكات النشطة.",
    notExpired: "التجديد متاح فقط للاشتراكات المنتهية الصلاحية.",
    incompatibleLane: "الانتقال إلى خطة على مسار رصيد مختلف غير مدعوم.",
    inactivePlan: "الخطة المحددة غير مفعلة.",
    samePlan: "الخطة المحددة هي نفس خطة الاشتراك الحالية.",
    prorationOverflow: "ستتجاوز نافذة صلاحية الاشتراك الناتجة أو عدد الجلسات الحد الأقصى المسموح به.",
    alreadyRenewed: "تم تجديد هذا الاشتراك بالفعل.",
    alreadyPlanChanged: "تم تغيير خطة هذا الاشتراك بالفعل.",
  },
