...
import { RegisterAccountSection } from "@/app/(auth)/register/RegisterAccountSection";
import { RegisterPreferencesSection } from "@/app/(auth)/register/RegisterPreferencesSection";
import { RegisterSubmitButton } from "@/app/(auth)/register/RegisterSubmitButton";
import { getRoleHelperText } from "@/app/(auth)/register/registerFormUtils";
import { useRegisterFormState } from "@/app/(auth)/register/useRegisterFormState";
import { useRegisterSubmit } from "@/app/(auth)/register/useRegisterSubmit";
