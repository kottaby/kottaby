...
import { PasswordStrengthMeter } from "@/app/(auth)/register/PasswordStrengthMeter";
import { RegisterIdentityFields } from "@/app/(auth)/register/RegisterIdentityFields";
import {
  genderFromSelectValue,
  MIN_PASSWORD_LENGTH,
  type RegisterFormValues,
} from "@/app/(auth)/register/registerFormUtils";
import { SectionLabel } from "@/app/(auth)/register/SectionLabel";
